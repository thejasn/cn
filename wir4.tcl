...
#Topology Design	
$ns_ at 0.0 "$node_(0) setdest 150.0 300.0 2.0"
$ns_ at 0.0 "$node_(1) setdest 300.0 500.0 2.0"
$ns_ at 0.0 "$node_(2) setdest 500.0 500.0 2.0"
$ns_ at 0.0 "$node_(3) setdest 300.0 150.0 2.0"
$ns_ at 0.0 "$node_(4) setdest 500.0 100.0 2.0"
$ns_ at 0.0 "$node_(5) setdest 650.0 300.0 2.0"

$ns_ at 4.0 "$node_(3) setdest 300.0 300.0 5.0"
